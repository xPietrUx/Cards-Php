...
<?php
    ...
    if(isset($_POST["tittleVechicle"]) && isset($_POST["tittleDescriptionSmaller"]) && isset($_POST["tittleDescriptionBigger"]))
    {
        ...
        $query = $mysqli -> query("INSERT INTO carsales VALUES (NULL,'$tittleVechicle','$tittleDescriptionSmaller','$tittleDescriptionBigger')");
    }
        ...
        for($i=0;$i<count($file_array);$i++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    $sql = "INSERT IGNORE INTO carsalesphotos (img_name,img_dir,img_dir_folder,ID_CarSalesImageTo) VALUES('$name','$img_dir', '$foldername',(SELECT MAX(carsales.ID_CarSales) FROM carsales))";
