...
<body>
    ...
    <div class="CarsChooseH">
      <ul>
        <li><a href="../CarSales/CarSalesR.php">Sprzedaż samochodów</a>
          <div class="under" class="active"></div>
        </li>
        <li><a href="../ClassicCars/ClassicCarsR.php">Klasyczne samochody</a>
          <div class="under"></div>
        </li>
        <li><a href="#">Wynajem samochodów</a>
  ...
  <div class="ContainerMainH">
        ...
        <form action="CarRentalDownload.php" method="POST" enctype="multipart/form-data">
          <div class="Slajder">
        ...
        <?php
             ...
             while($data = $carsales->fetch_assoc())
             {
                ...
                echo '</div>
                 ...
                 <form action="CarRentalDelete.php" method="POST" style="width: 50%">
