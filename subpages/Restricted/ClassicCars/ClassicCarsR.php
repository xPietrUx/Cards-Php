...
<body>
  <div class="menuH">
    ...
    <div class="CarsChooseH">
      <ul>
        ...
        <li><a href="#">Klasyczne samochody</a>
  ...
  <div class="ContainerMainH">
        ...
        <form action="ClassicCarsDownload.php" method="POST" enctype="multipart/form-data">
          <div class="Slajder">
        ...
        <?php
             ...
             while($data = $carsales->fetch_assoc())
             {
                ...
                echo '</div>
                 ...
                 <form action="ClassicCarsDelete.php" method="POST" style="width: 50%">
