...
<?php
    ...
    if(isset($_POST["tittleVechicle"]) && isset($_POST["tittleDescriptionSmaller"]) && isset($_POST["tittleDescriptionBigger"]))
    {
        ...
        $query = $mysqli -> query("INSERT INTO classiccars VALUES (NULL,'$tittleVechicle','$tittleDescriptionSmaller','$tittleDescriptionBigger')");
    }
        ...
        for($i=0;$i<count($file_array);$i++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    $sql = "INSERT IGNORE INTO classiccarsphotos (img_name,img_dir,img_dir_folder,ID_ClassicCarImageTo) VALUES('$name','$img_dir', '$foldername',(SELECT MAX(classiccars.ID_ClassicCar) FROM classiccars))";
