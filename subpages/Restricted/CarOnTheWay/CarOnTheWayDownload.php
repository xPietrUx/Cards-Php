...
<?php
    ...
    if(isset($_POST["tittleVechicle"]) && isset($_POST["tittleDescriptionSmaller"]) && isset($_POST["tittleDescriptionBigger"]))
    {
        ...
        $query = $mysqli -> query("INSERT INTO carontheway VALUES (NULL,'$tittleVechicle','$tittleDescriptionSmaller','$tittleDescriptionBigger')");
    }
        ...
        for($i=0;$i<count($file_array);$i++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    $sql = "INSERT IGNORE INTO caronthewayphotos (img_name,img_dir,img_dir_folder,ID_CarOnTheWayImageTo) VALUES('$name','$img_dir', '$foldername',(SELECT MAX(carontheway.ID_CarOnTheWay) FROM carontheway))";
