...
<body>
  ...
  <div class="menuH">
    ...
    <ul>
        <li><a href="CarSales.php">Sprzedaż samochodów</a><div id="thispage" class="active"></div></li>
  ...
  <?php
             ...
             while($data = $carsales->fetch_assoc())
             {
                 ...
                 foreach($carsalesphotosFirst as $data1)
                 {
                      ...
                      {
                        echo '<img src="../Restricted/CarSales/'.$img_dir.'" width="100%" alt="">';
                      }
                 }
                     ...
                     foreach($carsalesphotos as $data2)
                     {
                      ...
                      $ID_CarSalesImageTo = $data2['ID_CarSalesImageTo'];
                        ...
                        echo '<div class="carousel-item">
                                <img src="../Restricted/CarSales/'.$img_dir.'" class="d-block w-100" alt="...">
                                </div>';
                        }
                     }
                     echo '</div>
